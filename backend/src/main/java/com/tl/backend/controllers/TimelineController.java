...
public class TimelineController {
    ...
    @Autowired
    public TimelineController(TimelineService timelineService, TimelineMapper timelineMapper, UserRepository userRepository){
    ...
    public ResponseEntity<Timeline> createTimeline(Authentication authentication, @RequestBody @Valid @NotNull Timeline timeline, @RequestParam Boolean findUser){
        if (findUser){
